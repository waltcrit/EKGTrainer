    ...
    <div className="max-w-2xl mx-auto flex flex-col gap-6 pb-8">
      ...
      <div className="rounded-xl border border-sky-100 bg-sky-50 overflow-hidden">
        ...
        <div className="px-5 py-4 flex flex-col gap-4">
          ...
          {/* Primary citation */}
          <div className="rounded-lg bg-white border border-sky-100 px-4 py-3 flex flex-col gap-1">
          ...
          {/* License */}
          <div className="flex items-start gap-3 rounded-lg bg-white border border-sky-100 px-4 py-3">
            <svg className="w-4 h-4 text-sky-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
